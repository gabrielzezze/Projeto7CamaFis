...
# Title: Top Block
# Generated: Thu Nov  7 14:33:09 2019
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._fs_range_range = Range(0, 18000, 1, 4000, 200)
        self._fs_range_win = RangeWidget(self._fs_range_range, self.set_fs_range, 'fs', "counter_slider", int)
        self.top_layout.addWidget(self._fs_range_win)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fs_range, 1, 0)
        ...
        self.connect((self.digital_constellation_modulator_0, 0), (self.blocks_complex_to_real_1, 0))
    ...
    def get_fs_range(self):
        return self.fs_range

    def set_fs_range(self, fs_range):
        self.fs_range = fs_range
        self.analog_sig_source_x_0.set_frequency(self.fs_range)
